    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="{{URL::to('public/frontend/images/product-1.png')}}" class="image-popup prod-img-bg"><img src="{{URL::to('public/frontend/images/product-1.png')}}" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
