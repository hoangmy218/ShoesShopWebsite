                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body chat-box scrollable" style="height:300px;">
                                        <ul class="chat-list">
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{asset('public/backend/img/users/1.jpg')}}" alt="user"></div>
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{asset('public/backend/img/users/2.jpg')}}" alt="user"></div>
                                                <div class="chat-content">
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{asset('public/backend/img/users/3.jpg')}}" alt="user"></div>
                                                <div class="chat-content">
                            ...
                            <div class="col-md-4">
                                <div class="card" style="min-height: 422px;">
                                    ...
                                    <div class="card-body timeline">
                                        <div class="header bg-theme" style="background-image: url({{URL::to('public/backend/img/placeholder/placeimg_400_200_nature.jpg')}}">
                                ...
                                <table id="advanced_table" class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="{{asset('public/backend/img/users/1.jpg')}}" class="table-user-thumb" alt=""></td>
                                            <td>Tiger Nixon</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('public/backend/img/users/2.jpg')}}" class="table-user-thumb" alt=""></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('public/backend/img/users/3.jpg')}}" class="table-user-thumb" alt=""></td>
                                            <td>Ashton Cox</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('public/backend/img/users/4.jpg')}}" class="table-user-thumb" alt=""></td>
                                            <td>Cedric Kelly</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('public/backend/img/users/5.jpg')}}" class="table-user-thumb" alt=""></td>
                                            <td>Airi Satou</td>
                                            <td>Accountant</td>
                                            <td>Tokyo</td>
                                            <td>33</td>
                        ...
                        <div class="chat-list">
                            <div class="list-group row">
                                ...
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Billy Black">
                                    <figure class="user--online">
                                        <img src="{{asset('public/backend/img/users/2.jpg')}}" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Billy Black</span>  <span class="username">@billyblack</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Herbert Diaz">
                                    <figure class="user--online">
                                        <img src="{{asset('public/backend/img/users/3.jpg')}}" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Herbert Diaz</span>  <span class="username">@herbert</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Sylvia Harvey">
                                    <figure class="user--busy">
                                        <img src="{{asset('public/backend/img/users/4.jpg')}}" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Sylvia Harvey</span>  <span class="username">@sylvia</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item active" data-chat-user="Marsha Hoffman">
                                    <figure class="user--busy">
                                        <img src="{{asset('public/backend/img/users/5.jpg')}}" class="rounded-circle" alt="">
